      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              children: [
                RateBar(star: 5, value: numOfFiveStar / (numOfReviews == 0 ? 1 : numOfReviews)),
                RateBar(star: 4, value: numOfFourStar / (numOfReviews == 0 ? 1 : numOfReviews)),
                RateBar(star: 3, value: numOfThreeStar / (numOfReviews == 0 ? 1 : numOfReviews)),
                RateBar(star: 2, value: numOfTwoStar / (numOfReviews == 0 ? 1 : numOfReviews)),
                RateBar(star: 1, value: numOfOneStar / (numOfReviews == 0 ? 1 : numOfReviews)),
              ],
            ),
          ),
        ],
